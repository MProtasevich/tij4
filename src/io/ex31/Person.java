...
public class Person {
    ...
    public static void main(String[] args) throws Exception {
        List<Person> people = Arrays.asList(new Person("Dr. Bunsen",
                "Honeydew", "1234 Main Street"), new Person("Gonzo",
                "The Great", "Top-o-the-heap"), new Person("Phillip J.",
                "Fry", "66 Beat Street"));
        ...
        format(new BufferedOutputStream(new FileOutputStream("People31.xml")),
                doc);
    }
}